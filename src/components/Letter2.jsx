...
function Letter({ title, paragraphs, speed, onClose }) {
  ...
  return (
    <div className="letter" ref={letterContentRef} style={{ overflowY: "auto", maxHeight: "vh" }}>
